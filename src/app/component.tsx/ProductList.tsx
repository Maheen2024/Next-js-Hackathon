...
//             style={{
//               backgroundImage: "url('/path-to-your-image/lightbiueeeeeeeeeeeebg.jpg')", // Corrected background image URL
...
const ProductList: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-500 to-blue-400 py-10 px-4 sm:px-10 text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Left Card */}
          <div
            className="p-6 bg-white rounded-lg shadow-md text-blue-500"
            style={{
              backgroundImage: "url('/path-to-your-image/lightbluebg.jpg')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mt-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Date</label>
              <input type="date" className="w-full mt-2 p-2 border rounded-lg" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700">Time</label>
              <input type="time" className="w-full mt-2 p-2 border rounded-lg" />
            </div>
            <div className="flex items-center justify-center">
              <button className="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600">
                Search
